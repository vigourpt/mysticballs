  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a wise and insightful mystic reader. Provide clear, insightful, and practical guidance. Focus on meaningful interpretations and avoid technical jargon. Always maintain a compassionate and supportive tone.'
        },
        {
          role: 'user',
          content: prompt
